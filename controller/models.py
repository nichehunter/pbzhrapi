...
class Person(models.Model):
    ...
    gender = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="gender"
    )
...
class Staff(Person):
    ...
    staff_category = models.CharField(max_length=20, default="primary")
    ...
    employment_status = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="status", null=True
    )
...
class StaffQualification(models.Model):
    ...
    qualification_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="type"
    )
...
class Supervisor(models.Model):
    ...
    supervise_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="super_type"
    )
    is_active = models.BooleanField(default=True)
...
class Branch(models.Model):
    ...
    bank_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="bank_type", null=True
    )
    branch_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="branch_type"
    )
    branch_location = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="branch_location"
    )
    parent_branch = models.ForeignKey(
        "self", blank=True, null=True, related_name="parent", on_delete=models.RESTRICT
    )
    is_active = models.BooleanField(default=True)
    recorded_by = models.PositiveIntegerField(null=False)
    recorded_at = models.DateTimeField(auto_now_add=True, null=True)
...
class StaffDepartment(models.Model):
    ...
    staff = models.ForeignKey(
        Staff, on_delete=models.RESTRICT, related_name="staff_department"
    )
...
class StaffBenefit(models.Model):
    ...
    benefit_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="benefit_type"
    )
...
class StaffBenefitDependent(models.Model):
    ...
    benefit_dependent = models.ForeignKey(
        Person, on_delete=models.RESTRICT, related_name="benefit_dependent"
    )
    is_active = models.BooleanField(default=True)
    remaks = NameField(max_length=512, blank=True, null=True)
    recorded_by = models.PositiveIntegerField(null=False)
...
class StaffHealthFund(models.Model):
    staff = models.ForeignKey(Staff, on_delete=models.RESTRICT)
    fund = models.ForeignKey(HealthFund, on_delete=models.RESTRICT)
    is_active = models.BooleanField(default=True)
    recorded_by = models.PositiveIntegerField(null=False)
    recorded_at = models.DateTimeField(auto_now_add=True, null=True)
...
class Document(models.Model):
    ...
    document_type = models.ForeignKey(
        DictionaryItem, on_delete=models.RESTRICT, related_name="document_type"
    )
